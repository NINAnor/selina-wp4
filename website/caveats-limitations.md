...
Thank you for reading this page! Caveats and limitations usually scare people away, but not you it seems!

Our writing guidance aims to be user-friendly, and to accommodate a wide variety of context and purposes to commission ecosystem service assessments. Despite our best efforts though, we still haven't managed to make it truly magical. This is still a work in progress and there are some caveats and limitations that you should be aware of:
...
* The online survey version of the guidance is not 100% complete compared to the PDF templates. This is due to the limited resources we had to build the website. But don't worry, we still made sure you would have the essentials! The online survey covers the most important sections of the Frame & Scope PDF template and fully integrates the Methodology PDF template. To ease first time use, we have nt included the Evaluation Criteria section. Once you drafted your Terms of Reference with our online survey, you can go to the Evaluation Criteria PDF template [here](/static/SELINA_ToR_pdf_templates.pdf). After using our online survey, this template should be easy to use for more detailed follow-up work. We have no doubt you will do just fine with it!
